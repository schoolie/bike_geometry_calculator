...
if __name__ == '__main__':
    ...
    equations = [
                 ...
                 sp.Eq(crown_to_steering_axis_intersection, fork_length+fork_offset*sp.tan(head_tube_angle*to_rad) + ground_trail/sp.cos(head_tube_angle*to_rad)),
                 sp.Eq(saddle_extension, saddle_height - seat_tube_length),
                ]
                
    print (len(equations), len(var_names), len(input_names))
    
    soln = sp.solve(equations, [stack, 
                                 reach, 
                                 ht_top_to_ground, 
                                 wheel_radius, 
                                 wheelbase, 
